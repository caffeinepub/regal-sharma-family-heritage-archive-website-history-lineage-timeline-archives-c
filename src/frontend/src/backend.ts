...
export class Backend implements backendInterface {
    ...
    async submitForm(arg0: string, arg1: Submission): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitForm(arg0, to_candid_Submission_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        attachmentMetadata: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.attachmentMetadata)),
        relationshipOrAffiliation: value.relationshipOrAffiliation
    };
}
...
function to_candid_Submission_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Submission): _Submission {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        message: value.message,
        attachmentMetadata: value.attachmentMetadata ? candid_some(value.attachmentMetadata) : candid_none(),
        relationshipOrAffiliation: value.relationshipOrAffiliation
    };
}
